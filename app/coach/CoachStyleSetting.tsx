  ...
  return (
    <div className="px-4 mb-3">
      ...
      >
        ...
        <span className="flex-1 text-left">Coaching voice {value ? '· set' : '· default'}</span>
        <span className="text-stone-500 text-xs">{open ? 'Hide' : 'Edit'}</span>
      </button>

      {open && (
        <div className="mt-2 bg-stone-900 border border-stone-800 rounded-2xl p-3">
          <p className="text-stone-400 text-xs mb-2">
            How should Copilot drafts sound? e.g. “warm and casual, light on emoji” or “direct, no-nonsense, motivating”.
          </p>
          <textarea
            value={value}
